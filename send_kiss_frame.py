...
# Code originally from: https://thomask.sdf.org/blog/2018/12/15/sending-raw-ax25-python.html
# Only modification made was to write output to a file instead of a socket
...
#s.send(output)
#s.close()
#frame = aprs.parse_frame("KE8EZC>APRS:>Testing")


f = open("/dev/soundmodem0", "w")
f.write(output)
#print(str(frame))
f.close()
